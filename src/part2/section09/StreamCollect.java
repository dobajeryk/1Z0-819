...
// beginning/ending bracket
        ...
        double AverageGPA = Stream.of(new Studentt("Jeff", 2.7f),
                new Studentt("Carol", 3.5f),
                new Studentt("Andy", 1.7f))
                .collect(Collectors.averagingDouble(Studentt::getGpa));
...
// Get Summary Statistics (about the gpa) from a Stream<Student>
        DoubleSummaryStatistics gpaStats = Stream.of(new Studentt("Jeff", 2.7f),
                new Studentt("Carol", 3.5f),
                new Studentt("Andy", 1.7f))
                .collect(Collectors.summarizingDouble(Studentt::getGpa));
...
class Studentt {
    ...
    // Constructor
    Studentt(String name, float gpa) {
        this.name = name;
        this.gpa = gpa;
    }
